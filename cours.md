...
categorie : main
description: Issy Les Moulineaux, Paris, Puteaux, Versailles
image: assets/images/pic02c.jpg
---
...
<section id="one">
    ...
    <div class="row">
        <div class="3u 12u$(medium)"> <!-- gauche-->
          <h3>{{ aclass.name }}</h3>
          <a href="{{ aclass.bookinglink }}" class="button small" target="{{ aclass.bookingtarget }}">S'inscrire</a>
					<br><br>
        </div>
